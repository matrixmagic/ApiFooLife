...
class RestaurantController extends Controller
{
    ...
    public function index()
    {
        ...
        $page_title = 'Restaruant';
        $page_description = 'Here is your Restaruant  data';
        $logo = "images/logo.png";
        $logoText = "images/logo-text.png";
		
        $action = "restaurant";
        return view('restaurant.create', compact('page_title', 'page_description','action','logo','logoText','restaurant'));
    }
