...
class SegoadminController extends Controller
{
    ...
    public function orders()
    {
        ...
        return view('dashboard.orders', compact('page_title', 'page_description','action','logo','logoText'));
    }
	
	     // Order Id
    public function order_id()
    {
        $page_title = 'Order ID #5552351';
        $page_description = '';
        $logo = "images/logo.png";
        $logoText = "images/logo-text.png";
        ...
        return view('dashboard.order_id', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // General Customers
    public function general_customers()
    {
        ...
        return view('dashboard.general_customers', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Analytics
    ...
    // Ajax Selling Items
    public function selling_items()
    {
        return view('dashboard.selling_items');
    }
    
    // Ajax Favourite Items
    public function favourite_items()
    {
        return view('dashboard.favourite_items');
    }
	    // Reviews
