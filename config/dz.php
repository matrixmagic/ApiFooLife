...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Sego Laravel'),
		...
		'pagelevel' => [
			'css' => [
				...
				'product_create' => [
					...
					'lib/nouislider/distribute/nouislider.min.css',
					'assets/css/icomoon/style.css',
					'assets/css/styles.css',
					'assets/css/ToggleSwitches.css',
