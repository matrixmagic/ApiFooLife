...
<div class="container-fluid">
  ...
  <div class="d-sm-flex mb-lg-4 mb-2">
    ...
    <a href="{{url("/products/create")}}" class="btn btn-primary  btn-rounded ml-auto"   >+Add </a>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex">
                  ...
                  <a href="{{url("/products/deleteItem")."/".$item->id}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                </div>												
              </td>												
            </tr>
            @endforeach
