          ...
          <div id="smartwizard" class="form-wizard order-create">
            ...
            <div class="tab-content">
              ...
              <div id="wizard_Service" class="tab-pane" role="tabpanel">
                <div class="row">
                  <div class="col-lg-6 mb-2">
                    <div class="form-group">
                      <label class="text-label">ٌResutrant Name*</label>
                      <input type="text" name="name" class="form-control" value="@if($restaurant!=null)
                      {{$restaurant->name}}
                      @endif" required>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="city" class="form-control"  value="@if($restaurant!=null)
                      {{$restaurant->city}}
                      @endif" >
                    </div>
                  </div>
                  <div class="col-lg-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="address" class="form-control" value="@if($restaurant!=null)
                      {{$restaurant->address}}
                      @endif" >
                    </div>
                  </div>
                  <div class="col-lg-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="street" class="form-control" value="@if($restaurant!=null)
                      {{$restaurant->street}}
                      @endif" >
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6 mb-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="fax" class="form-control"  value="@if($restaurant!=null)
                      {{$restaurant->fax}}
                      @endif">
                    </div>
                  </div>
              ...
              <div id="wizard_Details" class="tab-pane" role="tabpanel">
                  <input id="fileId" type="hidden" name="file_id" value="@if($restaurant!=null)
                  {{$restaurant->file_id}}
                  @endif">
                ...
                <div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="portfolio-item">
							...
							<div id="add-places" class="small-map" style="padding-bottom: 40%;"></div>
							<p class="pull-right">
...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDBneP6plp_SpuDE3gYwBr94ED8j5d7aHw"></script>
<script>
    $("#add-places").mapsed({
